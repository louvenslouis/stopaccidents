...
export function ArmedPresenceReportSheet({
  ...
  const { draft, setDraft, step, setStep, savedSteps, setSavedSteps, receipt, setReceipt, ready, storageError, checkpoint, retryStorage } = useReportDraft('armed_presence', makeDraft, visible);
  const eventChoice = useEventChoice('armed_presence');
                  ...
                  <>
                    ...
                    <View style={styles.sectionHeading}>
                      <View style={styles.sectionIcon}>
                        <AppIcon icon={UsersRound} color={themeColor("#D94235", 'accent')} size={23} />
                      </View>
                      <View style={styles.flex}>
                    ...
                    <View style={styles.summary}>
                      ...
                      <View style={styles.inline}>
                        ...
                        <Text style={[styles.small, styles.flex]}>
                          {armedPresenceLocationDescription(draft) ? <Text translate={false}>{armedPresenceLocationDescription(draft)}</Text> : 'Position GPS ajoutée'}
                        </Text>
                      </View>
                      <Text numberOfLines={3} style={styles.summaryDetails}>
                        {<Text translate={false}>{draft.presence.trim()}</Text>}
                      </Text>
                      <Text numberOfLines={2} style={styles.summaryDetails}>
                        Activité : {<Text translate={false}>{draft.activity.trim()}</Text>}
                      </Text>
                    </View>
                    <View style={styles.sectionHeading}>
                      <View style={styles.sectionIcon}>
