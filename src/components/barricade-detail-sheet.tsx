...
import { readBarricadeReport } from '@/features/safety-report/read';
              ...
              <>
                ...
                <View style={styles.summary}>
                  ...
                  <View style={styles.heading}>
                    ...
                    <Text style={styles.reportTitle}>Route barricadée</Text>
                  </View>
                </View>
                ...
                <Section title="Lieu de la route barricadée">
                  ...
                  <Pressable
                    ...
                    <AppIcon icon={ArrowUpRight} size={17} color={themeColor("#B96B16", 'warning')} />
                  </Pressable>
                  {mapError && (
                ...
                <Section title="Informations du signalement">
                  ...
                  <Section title="État de la route">
                    <Text style={styles.muted}>
                      Informations déclarées par un usager, non vérifiées.
                    </Text>
                    <Text style={styles.label}>Obstacles</Text>
                    <Text selectable style={styles.body}>
                      {report.obstacles || 'Non renseigné'}
                    </Text>
                    <Text style={styles.label}>Possibilité de passage</Text>
                    <Text selectable style={styles.body}>
                      {report.passage ? <Text translate={false}>{report.passage}</Text> : 'Non renseignée'}
                    </Text>
...
const useStyles = createThemedStyles((themeColor) => StyleSheet.create({
  ...
  eyebrow: {
    ...
    fontWeight: '700',
    letterSpacing: 1.2,
    color: themeColor('#B96B16', 'warning'),
  },
  title: {
    fontSize: 22,
    fontWeight: '700',
  ...
  summary: {
    ...
    alignItems: 'center',
    gap: 12,
    backgroundColor: themeColor('#FFF8EB', 'warningSoft'),
    borderRadius: 20,
    padding: 18,
  },
  iconBox: {
    ...
    height: 50,
    borderRadius: 17,
    backgroundColor: themeColor('#FFF0D5', 'warningSoft'),
    justifyContent: 'center',
    alignItems: 'center',
  },
  ...
  linkText: { color: themeColor('#B96B16', 'warning'), fontSize: 13, fontWeight: '600' },
  status: {
